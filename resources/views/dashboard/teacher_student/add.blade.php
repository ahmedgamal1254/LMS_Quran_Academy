        ...
        <div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
            ...
            <div class="card  box-shadow-0">
                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{ route("teacher_student_relation") }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="myusers">اختر المدرس</label>
                            <input type="text" id="myTeacher" class="form-control" placeholder="Search...">
                            <select name="teacher" class="form-control" id="my_teacher">
                                <option selected>اختر المدرس</option>
                                @forelse($teachers as $teacher)
                                    <option value="{{ $teacher->id }}">{{ $teacher->name }}</option>
                                @empty
                                    <option disabled>لا يوجد مدرسين بعد</option>
                                @endforelse 
                            </select>
                        </div>
