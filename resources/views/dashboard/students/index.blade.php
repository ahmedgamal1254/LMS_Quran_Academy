...
@section('content')
    ...
    @endif
    <!-- row -->
    <h4 class="card-title mt-4">قائمةالطلاب بالاكاديمية</h4>
    <div class="container">
        <div class="row">
            <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                <thead>
                    <tr>
                        ...
                        <th class="wd-lg-25p tx-right">الباقة</th>
                        <th class="wd-lg-25p tx-right">المدرسين</th>
                ...
                <tbody>
                    ...
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td class="tx-right tx-medium tx-danger">{{ $user->offer_id }}</td>
                            <td class="tx-right tx-medium tx-danger"><a href="{{ route("student.teachers",$user->id) }}">عرض</a></td>
